        ...
        <div className="space-y-6">
          ...
          <Card title="Imagen de portada">
            <div className="space-y-4">
              {post?.coverKey && (
                <div>
                  <img src={`/media/${post.coverKey}`} alt="" className="aspect-[16/10] w-full rounded-xl object-cover shadow-xs" />
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="block w-full text-sm text-stone-600 file:mr-3 file:rounded-xl file:border-0 file:bg-forest-50 file:px-3.5 file:py-2 file:text-sm file:font-semibold file:text-forest-800 transition-colors file:cursor-pointer hover:file:bg-forest-100"
                />
                {errors?.cover?.[0] ? (
